...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <section class="content-header">
                 ...
                 <a href="{{ url('/did') }}"  type="submit" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i> Show Phone Number</a>
           </div>
       </section>
                                ...
                                <div class="form-group m-b-10">
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                <input type="text" onkeyup="check(); return false;" maxlength="12" onkeypress="return isNumberKey($(this));" class="form-control" name="cli" value=""
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                <input type="text" maxlength="13" class="form-control" name="cnam" value="" id="cnam" required=""
                         ...
                         <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group m-b-10">
                                        ...
                                        <div class="col-md-8 hide_show" id="user_0" style="display:block;">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                ...
                                                <option value={{$ivr_lst->ivr_id}}>{{$ivr_lst->ivr_desc}} - {{$ivr_lst->ivr_id}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            </div>
                                        ...
                                        <div class="col-md-8 hide_show" id="user_1" >
                                        ...
                                        <div class="input-daterange input-group col-md-12">
                                            <select class="form-control"  name="extension" id="extension">
                                                ...
                                                <option value={{$ext_lst->id}}>{{$ext_lst->first_name}} {{$ext_lst->last_name}} - {{$ext_lst->extension}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-8 hide_show" id="user_2">
                                        <label for="exampleInputEmail1">Destination <i data-toggle="tooltip" data-placement="right" title="Select the destination you wish to forward the calls to " class="fa fa-info-circle" aria-hidden="true"></i></label>
                                        <div class="input-daterange input-group col-md-12">
                                    ...
                                    <div class="col-md-8 hide_show" id="user_4">
                                        <label  for="exampleInputEmail1">DID</label>
                                        <div class="input-daterange input-group col-md-12">
                                            <input type="text" class="form-control"  name="forward_number" id="forward_number" placeholder="Enter the phone number in Format: +12345678901">
                                        </div>      
                                    </div>

                                    <div class="col-md-8 hide_show"  id="user_5">
                                        <label control-label" for="exampleInputEmail1">Destination <i data-toggle="tooltip" data-placement="right" title="Select the destination you wish to forward the calls to " class="fa fa-info-circle" aria-hidden="true"></i></label>
                                        <div class="input-daterange input-group col-md-12">
                                    ...
                                    <div class="col-md-8 hide_show" id="user_9">
                                        <label  for="exampleInputEmail1">Destination <i data-toggle="tooltip" data-placement="right" title="Select the destination you wish to forward the calls to " class="fa fa-info-circle" aria-hidden="true"></i></label>
                                        <div class="input-daterange input-group col-md-12">
                                    ...
                                    <div class="col-md-8 hide_show" id="user_6">
                                        <label  for="exampleInputEmail1">Destination <i data-toggle="tooltip" data-placement="right" title="Select the destination you wish to forward the calls to " class="fa fa-info-circle" aria-hidden="true"></i></label>
                                        <div class="input-daterange input-group col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group m-b-10">
                                        ...
                                        <div class="col-md-4">
                                            <label for="inputEmail3" class="sms_grid">Assign To User <i data-toggle="tooltip" data-placement="right" title="You can assign the Text feature to an user" class="fa fa-info-circle" aria-hidden="true"></i></label>
                                            ...
                                            <option value={{$ext_lst1->id}}>{{$ext_lst1->first_name}} {{$ext_lst1->last_name}} - {{$ext_lst1->extension}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="inputEmail3" class="sms_grid">Forward SMS To Mobile <i data-toggle="tooltip" data-placement="right" title="Type phone number with country code" class="fa fa-info-circle" aria-hidden="true"></i></label>
    ...
    <input type="text" maxlength="10" style="width:280px;" onkeypress="return isNumberKey($(this));" class="form-control"  name="sms_phone" id="sms_phone" placeholder="Your Phone Number">
</div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-daterange input-group col-md-12">
                                            <select class="form-control"  name="call_time_department_id" id="call_time_department">
                                                <option value="0" >No</option>
                                                @if (is_array($department_list->data) && !empty($department_list->data))
                        ...
                        <div class="row" id="OutOfHours" style="display: none;"> 
                            <div class="col-sm-12">
                                <div class="form-group m-b-10">
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 hideMe ooh_div" id="0_div_ooh"  style='display: block'>
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                ...
                                                @if (is_array($ivr_list))
                                                @foreach($ivr_list as $ivr_lst)
                                                <option value={{$ivr_lst->ivr_id}} >{{$ivr_lst->ivr_desc}} - {{$ivr_lst->ivr_id}}
                                                </option>
                                                @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div id="1_div_ooh" class="col-md-8 hideMe ooh_div" style='display: none;'>
                                            <label>Destination (Out Of Hours) <i data-toggle="tooltip" data-placement="right" title="Select destination for holiday" class="fa fa-info-circle" aria-hidden="true"></i></label>
                                            <div class="input-daterange input-group col-md-12">
                                        ...
                                        <div id="2_div_ooh" class="col-md-8 hideMe ooh_div" style='display: none;' >
                                            <label>Destination (Out Of Hours) <i data-toggle="tooltip" data-placement="right" title="Select destination for holiday" class="fa fa-info-circle" aria-hidden="true"></i></label>
                                            <div class="input-daterange input-group col-md-12">
                                        ...
                                        <div id="4_div_ooh" class="col-md-8 hideMe ooh_div" style='display: none;' >
                                        <label>Destination (Out Of Hours) <i data-toggle="tooltip" data-placement="right" title="Select destination for holiday" class="fa fa-info-circle" aria-hidden="true"></i></label>
                                        <div class="input-daterange input-group col-md-12">
                                            <input type="text" class="form-control" value=""  name="forward_number_ooh" id="forward_number" placeholder="Enter the phone number in Format: +12345678901">
                                        </div>      
                                    </div>

                                    <div id="5_div_ooh" class="col-md-8 hideMe ooh_div" style='display: none;'>
                                    ...
                                    <div id="9_div_ooh" class="col-md-8 hideMe ooh_div" style='display: none;' >
                                        <label  for="exampleInputEmail1">Destination (Out Of Hours) <i data-toggle="tooltip" data-placement="right" title="Select destination for holiday" class="fa fa-info-circle" aria-hidden="true"></i></label>
                                        <div class="input-daterange input-group col-md-12">
                                    ...
                                    <div id="8_div_ooh" class="col-md-8 hideMe ooh_div" style='display: none;' >
                                        <label  for="exampleInputEmail1">Destination (Out Of Hours) <i data-toggle="tooltip" data-placement="right" title="Select destination for holiday" class="fa fa-info-circle" aria-hidden="true"></i></label>
                                        <div class="input-daterange input-group col-md-12">
                                    ...
                                    <div id="6_div_ooh" class="col-md-8 ooh_div" style='display: none;' >
                                        <label  for="exampleInputEmail1">Destination <i data-toggle="tooltip" data-placement="right" title="Select destination for holiday" class="fa fa-info-circle" aria-hidden="true"></i></label>
                                        <div class="input-daterange input-group col-md-12">
                                            <select class="form-control select2" multiple  name="fax_did[]" id="fax_did_ooh" style="width:100%">
                                                @if (is_array($extension_list))
                                                @foreach($extension_list as $ext_lst_1)
                                                <option value={{$ext_lst_1->id}} >{{$ext_lst_1->first_name}} {{$ext_lst_1->last_name}} - {{$ext_lst_1->email}} - {{$ext_lst_1->extension}}
                                                </option>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group" style="float:right;">
                                    <tfoot>
                                        <tr>
                                            <td>
                                                <button id="submit" disabled="" class="btn btn-primary" type="submit"><i class="fa fa-check-square-o fa-lg"></i> 
                                                    Submit
                                                </button>
                                                &nbsp;
