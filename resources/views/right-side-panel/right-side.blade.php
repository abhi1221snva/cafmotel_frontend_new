<link rel="stylesheet" href="{{ asset('asset/css/contacts.css')}}">
<!-- Control Sidebar -->
<aside id="control-sidebar-dark" class="control-sidebar control-sidebar-dark">
    <!-- Create the tabs -->
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
        <!-- <li ><a href="#control-sidebar-phone-tab" data-toggle="tab"><img src="<?php echo e(asset('asset/img/telephone.png')); ?>"></a></li> -->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="control-sidebar-home-tab">
            <div class="users-chat-container">
                <div class="users-chat-header">
                    <h3>Contacts <span class="count"></span></h3>
                </div>
                <div class="chat-users-listing">

                </div>
                <input type="hidden" class="user-id" value="{{ Session::get('id') }}">
                <input type="hidden" class="video-url" value="{{ env('VIDEO_CALL_URL') }}">
            </div>
        </div>
        <!-- Phone tab content -->
        <div class="tab-pane " id="control-sidebar-phone-tab">
            <div id="divCallCtrl">
                ...
                <select class="form-control country_code" name="countryCode">
                ...
                <div class="dialpad-area">
                    <table style="width: 100%; height: 100%;margin: 10px 0px;">
                        <tr>
                ...
                <div id='divCallOptions' class='call-options' style='display:none;opacity: 0; margin-top: 10px'>
                    ...
                    <input type="button" class="btn btn-primary" style="" id="btnMute" value="Mute"
    ...
    {{-- Javascript code for Webphone --}}
    <script src="{{asset('asset/js/SIPml-api.js')}}" type="text/javascript"></script>
    <script src="{{asset('asset/js/sipml_custom.js')}}" type="text/javascript"></script>
    <script>
...
<script src="{{url('asset/js/chat/cf_custom_chat.js')}}"></script>
