@extends('layouts.app')
@section('title', 'Audio Message List')
    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Audio Message</li>
            </ol>
    </section>
    <section class="content-header">
       <div class="text-right mt-5 mb-3">
            <a href="{{ url('/audio-message') }}"  class="btn btn-sm btn-primary"><i class="fa fa-arrow-circle-left"></i>&nbsp;Back</a>
       </div>
        </section>
    ...
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form method="post" action="{{url('/audio-message')}}" enctype="multipart/form-data" class="edit_ivr_form">
                            @csrf
                            <div class="box-body">
...
{{--                                    </div>--}}
                            ...
                            <input type="hidden" value ="{{isset($ivr_data->speed) ? $ivr_data->speed : "1"}}" id="speed_value" name="speed_value">
                                ...
                                <button type="submit" name ="submit"  class="btn btn btn-primary waves-effect waves-light" style="float: right;">Save</button>
                        </form>
                    </div>
                </div>
            </div>
