    ...
    <!-- Content Header (Page header) -->
     ...
     <section class="content-header">
        ...
        <section class="content-header">
                 ...
                 <a id="openLabelForm" href='{{url('/edit-audio-message')}}/0' class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Audio Message</a>
           </div>
        </section>
        @endif
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a style="cursor:pointer;color:blue;" href="{{url('edit-audio-message')}}/{{$ivr->id}}" >
