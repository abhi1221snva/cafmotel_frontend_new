...
<div class="content-wrapper">
    ...
    <!-- Content Header (Page header) -->
     ...
     <section class="content-header">
                <h1>
                   <b>Custom Field Labels</b>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="{{url('/dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">Lead Management</li>
                    <li class="active">Custom Field Labels</li>
                </ol>
        </section>
        <section class="content-header">
            ...
            <a id="openLabelForm" type="submit" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Custom Field Label</a>
