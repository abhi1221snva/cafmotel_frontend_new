        ...
        <div class="row">
            ...
            <form class="form-inline"  method="post">
                ...
                <div class="panel panel-primary">
                    <div class="box-body">
                        @php
                        $labelStr = "<tr><td><input type='text' class='form-control' name='para_label[]' value='' class='param' required></td><td><select name='label[]' class='form-control' required='required'><option>Select Label</option>";
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div>
                                    <div class="input-daterange input-group col-md-12" id="date-range2">
                                        <input type="hidden" class="form-control" name="api_id" value="{{$api_data->id}}" id="api_id" required="">    
                                        <input type="text" class="form-control" name="title" value="{{$api_data->title}}" id="campaign_name" required="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <div class="input-daterange input-group col-md-12" id="date-range2">
                                        <input type="text" class="form-control" name="url" value="{{$api_data->url}}" id="campaign_name" required="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control"  name="method" autocomplete="off" data-placeholder="Select Group" style="width: 100%;">
                                    <option @if($api_data->method == 'get') selected @endif value="get">GET</option>
                                    <option @if($api_data->method == 'post') selected @endif value="post">POST</option>
                                </select>
                            </div>
                        </div>
                         <br>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select class="form-control"  name="campaign_id" autocomplete="off" data-placeholder="Select Group" style="width: 100%;">
                                    ...
                                    <option value="0">Default Campaign</option>
                                    @endif

                                    @if(!empty($campaign_list))

                                    @foreach($campaign_list  as $camp)
                                    <option @if($api_data->campaign_id == $camp->id) selected @endif  value="{{$camp->id}}">{{$camp->title}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="select2" multiple="multiple" name="disposition_id[]" autocomplete="off" data-placeholder="Select Disposition" style="width: 100%;">
                                    ...
                                    <option @if(in_array($dispo->id, $mapping))  selected  @endif value="{{$dispo->id}}">{{$dispo->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                             ...
                             <div class="col-md-3">
                                ...
                                <select class="form-control"  name="is_default" autocomplete="off" data-placeholder="Select Group" style="width: 100%;">
                                    <option @if($api_data->is_default == '0') selected @endif value="0">No</option>
                                    <option @if($api_data->is_default == '1') selected @endif value="1">Yes</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-refresh" aria-hidden="true"></i>
                                Update
                            </button>
                            &nbsp;
                ...
                <div class="col-xs-12" style="overflow-x: auto;">
                    ...
                    <table class="table table-bordered table-striped nowrap" id="api_table">
                        ...
                        <tbody id="param_label">
                            @foreach($api_data->parameter as $parameter)
                            @if($parameter->type == 'label')

                            <tr><td><input type='text' class='form-control' name='para_label[]' value='{{$parameter->parameter}}' class='param' required></td><td>

                                <select name='label[]' class='form-control' required='required'>
                                    @foreach($label_list  as $label)
                                    <option @if($parameter->value == $label->id) selected @endif value="{{$label->id}}">{{$label->title}}</option>
                                    @endforeach
                                </select></td><td><button class='btn btn-danger btn-remove'><i class='fa fa-trash'></i></button></td>
                            </tr>
                            @endif

                            @if($parameter->type == 'constant')
                            <tr><td><input type='text' class='form-control' name='para_constant[]' value='{{$parameter->parameter}}' class='param' required></td><td><input type='text' name='constant[]' class='form-control' value='{{$parameter->value}}' required='required'></td><td>
                                <button class='btn btn-danger btn-remove'><i class='fa fa-trash'></i></button></td>
                            </tr>
                            @endif
                            @endforeach
                        </tbody>
                            ...
                            <div class="modal-body" style="display:flex;">
                                <div class="col-md-12">
                                    <div class="form-group m-l-10 col-md-6">
                                        <label>Type <label>Disposition <i data-toggle="tooltip" data-placement="right" title="Select type" class="fa fa-info-circle" aria-hidden="true"></i></label></label>
                                    ...
                                    <div class="form-group m-l-10 col-md-4">
                                        <label>Number Of Rows <label>Disposition <i data-toggle="tooltip" data-placement="right" title="Select number of rows" class="fa fa-info-circle" aria-hidden="true"></i></label></label>
                                        <div class="input-daterange input-group col-md-12">
