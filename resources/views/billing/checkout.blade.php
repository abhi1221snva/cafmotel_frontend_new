                                    ...
                                    <div class="form-group m-b-10">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                <input type="text" maxlength="30" class="form-control" name="full_name" value=""
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group m-b-10">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                <input type="text" maxlength="100" class="form-control" name="line1" value=""
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                <input type="text" maxlength="50" class="form-control" name="city" value="" id="city"
                                                       placeholder="City">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <label>State <i data-toggle="tooltip" data-placement="right" title="Select your state/provinces from the dropdown" class="fa fa-info-circle" aria-hidden="true"></i><span style="color:red;">*</span></label>
                                            <div class="input-daterange input-group col-md-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group m-b-10">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                <input type="text" maxlength="20" class="form-control" name="postal_code" value=""
                        ...
                        <div class="box-body">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#CC_tab" data-toggle="tab" aria-expanded="true">Credit Card</a></li>
                                    <li class=""><a href="#paypal_tab" data-toggle="tab" aria-expanded="false">Paypal</a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane active" id="CC_tab">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group m-b-10">
                                                    <div class="col-md-6">
                                                        <label>Card Holder Name <i data-toggle="tooltip" data-placement="right" title="Type card holder name" class="fa fa-info-circle" aria-hidden="true"></i><span style="color:red;">*</span></label>
                                                        <div class="input-daterange input-group col-md-12">
                                                            <input type="text" maxlength="50" class="form-control" name="name" value="" id="name"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-daterange input-group col-md-12">
                                                            <input type="text" pattern="\d*" minlength="16" maxlength="19" onkeypress="return isNumberKey($(this));" class="form-control" name="number" value="" id="number"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group m-b-10">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-daterange input-group col-md-12">
                                                            <input type="text" pattern="\d*" minlength="3" maxlength="4" onkeypress="return isNumberKey($(this));" class="form-control" name="cvc" value="" id="cvc"
                                                                   placeholder="XXX2" >
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group m-b-10">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="input-daterange input-group col-md-12">
                                                            <input type="number" class="form-control" name="amount" value="{{$intCartTotal}}"
                                                                   id="amount"  placeholder="4500" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group m-b-10">
                                                    <div class="col-md-12">
                                                        <span style="color:red;"><b>Card information will be automatically saved for auto refill</b></span>&nbsp;
    ...
    <section class="waiting-section" style="display: none">
        <div class="waiting-box">
            ...
            <div class="payment-completed" style="display: none">
                <img src="{{asset("asset/img/loader-30px.gif")}}"/>
                <p class="payment-completed-text">Thank you for your payment. We are setting up your Dashboard!</p>
...
<script>
    ...
    function attachCustomerAndPaymentMethod(payment_method) {
        $.ajax({
            type:'POST',
            url: '{{url('stripe/attach-customer-and-payment-method')}}',
            data: {
                'payment_method' : payment_method
            },
            success: function (response) {
                if(response.success == 'true') {
                    addBalance(payment_method);
                } else {
                    $.each(response.errors, function( index, value ) {
                        toastr.error(value);
                    });
    ...
    function addBalance(payment_method) {
        $.ajax({
            type:'POST',
            url: "{{url('pay')}}",
            data: {
