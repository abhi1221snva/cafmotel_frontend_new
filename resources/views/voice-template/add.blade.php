...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <b>Add Voice Template</b>
        </h1>

        <ol class="breadcrumb">
            <li><a href="{{url('/dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Voice</li>
            <li class="active">Add Voice Template</li>
        </ol>
    </section>
                    ...
                    <form method="post" name="userform" id="userform" action="">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Templete Name <i data-toggle="tooltip" data-placement="right" title="Type Voice template name" class="fa fa-info-circle" aria-hidden="true"></i></label>
                            ...
                            <input type="hidden" value ="0.00" id="pitch_value" name="pitch_value">
                            <input type="hidden" value ="1" id="speed_value" name="speed_value">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-daterange input-group col-md-12">
                                            <textarea type="text" class="form-control" name="templete_desc" value="" id ="speech_text"></textarea>
