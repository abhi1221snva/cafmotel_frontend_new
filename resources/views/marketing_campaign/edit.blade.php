                                    ...
                                    <div class="form-group m-b-10">
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                <input type="text" value="{{$marketing_campaign['title']}}" id="title" class="form-control" name="title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                <textarea type="text" class="form-control" name="description" >{{$marketing_campaign['description']}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
