                ...
                <div class="modal-body">
                    <div class="form-group m-b-10">
                         ...
                         <input type="hidden" class="form-control" value="{{$sms_templete[0]->templete_id}}" name="templete_id" >
                           <div class="col-md-3">
                             <label>Templete Name <i data-toggle="tooltip" data-placement="right" title="Write sms template name" class="fa fa-info-circle" aria-hidden="true"></i></label>
                        ...
                        <div class="col-md-12">
                             <label>Templete <i data-toggle="tooltip" data-placement="right" title="Add or modify Templete Preview" class="fa fa-info-circle" aria-hidden="true"></i></label>
                            <div class="input-daterange input-group col-md-12">
                                <textarea type="text" class="form-control" name="templete_desc" value="" id ="message">{{$sms_templete[0]->templete_desc}}</textarea>
                            </div>
                        </div>
