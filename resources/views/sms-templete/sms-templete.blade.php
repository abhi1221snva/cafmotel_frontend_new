...
<div class="content-wrapper" style="min-height:500px !important">
    <!-- Content Header (Page header) -->
       ...
       <section class="content-header">
                <h1>
                   <b>SMS Templete List</b>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="{{url('/dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">SMS</li>
                    
                    <li class="active">SMS Templete List</li>
                </ol>
        </section>
        <section class="content-header">
               ...
               <a href="{{ url('/add-sms-templete') }}" type="submit" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add SMS Templete</a>
           </div>
        </section>
                        ...
                        <table id="example" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a style="cursor:pointer;color:blue;" href="{{url('editSmsTemplete')}}/{{ $templete->templete_id}}" class='editEG'><i class="fa fa-edit fa-lg"></i></a> |
                                        <a @if($templete->is_deleted == 1) style="cursor:pointer;color:green;" @else style="cursor:pointer;color:red;" @endif   class='openSmsTemplete' data-status={{$templete->is_deleted}} data-id={{$templete->templete_id}}> @if($templete->is_deleted == 1) <i class="fa fa-check fa-lg"></i> @else <i class="fa fa-check fa-lg"></i> @endif </a>
                                        |
                                        <a style="cursor:pointer;color:red;" href="javascript:deleteSmsTemplate({{ $templete->templete_id }})" id='delete-{{ $templete->templete_id }}'><i class="fa fa-trash fa-lg"></i></a>
                                       </td>
            ...
            <div class="modal fade" id="delete" role="dialog">
                ...
                <div class="modal-dialog">
                    <div class="modal-content" style="background-color: #d33724 !important;color:white;">
                        ...
                        <div class="modal-body">
                            <p>You are about to change <b><i class="title"></i></b> Sms Templete status.</p>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                            <button type="button" class="btn btn-danger btn-ok deleteSmsTemp">Update</button>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(".openSmsTemplete").click(function() {
    ...
    function deleteSmsTemplate(id) {
        ...
        $(document).on("click", ".deleteSmsTemp", function() {
        ...
        var el = this;
        $.ajax({
            url: 'deleteSmsTemplete/' + temp_id +'/'+status,
            type: 'get',
