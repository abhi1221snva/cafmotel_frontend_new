@include('layouts-chatify.headLinks')
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-body contacts-container">
           ...
           <div class="@if($type == 'user') show @endif messenger-tab users-tab app-scroll" data-view="users">
               ...
               {{-- Saved Messages --}}
               {!! view('layouts-chatify.listItem', ['get' => 'saved']) !!}
...
{{--                    <a target="_blank" style="color:{{$messengerColor}};" href="https://chatify.munafio.com/notes#groups-feature">Click here</a> for more info!--}}
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <a href="#" class="user-name">{{ env('CHAT_NAME') }}</a>
                </div>
                {{-- header buttons --}}
                <nav class="m-header-right">
        ...
        <div class="m-body messages-container app-scroll">
            ...
            {{-- Send Message Form --}}
            @include('layouts-chatify.sendForm')
        </div>
    </div>
    {{-- ---------------------- Info side ---------------------- --}}
    <div class="messenger-infoView app-scroll">
        ...
        {!! view('layouts-chatify.info')->render() !!}
    </div>
</div>

@include('layouts-chatify.modals')
@include('layouts-chatify.footerLinks')
