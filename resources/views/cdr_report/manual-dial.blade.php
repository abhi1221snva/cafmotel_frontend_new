...
<div class="content-wrapper">
    ...
    <section class="content-header">
                <h1>
                    <b>Manual Dial Calls</b>
                    
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active"> Call Data Reports</li>
                    <li class="active"> Manual Dial Calls</li>
                </ol>
        </section>
                    ...
                    <div class="panel-body">
                        <form class="form-inline" method="post">
                            ...
                            <div class="form-group m-l-10">
                                ...
                                <div>
                                    <div class="input-daterange input-group" id="date-range" style="width: 272px;">
                                        <input type="text" class="form-control col-md-6 datepicker" id="start_date" name="start" autocomplete="off" value="">
                                        <span class="input-group-addon bg-primary text-white b-0">to</span>
                                        <input type="text" class="form-control col-md-6 datepicker" id="end_date" name="end" autocomplete="off" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group m-l-10">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <audio controls preload='none'>
                                                <source src="<?php echo $value->call_recording;?>" type='audio/wav'>
                                            </audio>
                                        </td>
                                        <!-- <td>
