@extends('layouts.app')
@section('title', 'Edit Country Wise Rate')
@section('content')
...
<div class="row">
                                    <div class="col-md-12">
                                            ...
                                            <div class="input-daterange input-group col-md-12" style="margin-bottom: 10px;">
                                                ...
                                                <option @if($pack->key == $rate['package_key']) selected @endif value="{{$pack->key}}">{{$pack->name}} ({{$pack->key}})</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            </div>
                                    ...
                                    <div class="col-md-2">
                                            ...
                                            <div class="input-daterange input-group col-md-12" style="margin-bottom: 10px;">
                                                <select  required class="form-control"  name="country_code" id="country_code">
                                                    <option value="{{$rate['phone_code']}}">{{$rate['title_name']}} (+{{$rate['phone_code']}})</option>

                                                <!-- @if (is_array($phone_country))
                                                @foreach($phone_country as $code)
                                                <option  @if($code->phone_code == $rate['phone_code']) selected @endif value={{$code->phone_code}}>{{$code->country_name}} (+{{$code->phone_code}})
                                                </option>
                                                @endforeach
                                                @endif -->
                                            </select>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-daterange input-group col-md-12" style="margin-bottom: 10px;">
                                                <input required type="text" onkeypress="return isNumberKey($(this));" class="form-control" name="call_rate_per_minute" value="{{$rate['call_rate_per_minute']}}" id="call_rate_per_minute"  placeholder="Call Rate Per Minute">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <div class="input-daterange input-group col-md-12" style="margin-bottom: 10px;">
                                                <input required type="text" onkeypress="return isNumberKey($(this));" class="form-control" name="rate_six_by_six_sec" value="{{$rate['rate_six_by_six_sec']}}" id="rate_six_by_six_sec"  placeholder="Six By Six Sec">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-daterange input-group col-md-12" style="margin-bottom: 10px;">
                                                <input type="text" onkeypress="return isNumberKey($(this));" class="form-control" name="rate_per_sms" value="{{$rate['rate_per_sms']}}"
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <div class="input-daterange input-group col-md-12" style="margin-bottom: 10px;">
                                                <input type="text" onkeypress="return isNumberKey($(this));" class="form-control" name="rate_per_did" value="{{$rate['rate_per_did']}}" id="rate_per_did"  placeholder="Rate Per Phone No">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-daterange input-group col-md-12" style="margin-bottom: 10px;">
                                                <input type="text" onkeypress="return isNumberKey($(this));" class="form-control" name="rate_per_fax" value="{{$rate['rate_per_fax']}}" id="rate_per_fax"  placeholder="Rate Per Fax">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-daterange input-group col-md-12">
                                                <input type="text" onkeypress="return isNumberKey($(this));" class="form-control" name="rate_per_email" value="{{$rate['rate_per_email']}}" id="rate_per_email"  placeholder="Rate Per Email">
                                            </div>
                                        </div>
                                    </div>
