                ...
                <div class="box box-primary">
                    ...
                    @csrf
                        <div class="row">
                            ...
                            <input type="hidden" name="key" id="key" value="{{$package['key']}}">
                                        ...
                                        <div class="form-group m-b-10">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-daterange input-group col-md-12" style="margin-bottom: 10px;">
                                                    ...
                                                    <input type="text" onkeypress="return isNumberKey($(this));" class="form-control" name="base_rate_half_yearly_billed"  id="base_rate_half_yearly_billed" required=""
                                                        placeholder="Yearly" value="{{$package['base_rate_half_yearly_billed']}}">
                                                </div>
                                            </div>
                            ...
                            <div class="col-sm-3">
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="form-group m-b-10">
                                        ...
                                        <div class="col-md-12">
                                            <label>Per Phone No <i data-toggle="tooltip" data-placement="right" title="Type rate per phone number" class="fa fa-info-circle" aria-hidden="true"></i></label>
                                            <div class="input-daterange input-group col-md-12" style="margin-bottom: 10px;">
