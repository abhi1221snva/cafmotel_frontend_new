...
@section('content')
    ...
    height: 800px;overflow-x: hidden;overflow-y: auto;text-align: justify;">
                                        ...
                                        <ul class="nav nav-stacked call-disposition">
                                                            ...
                                                            <a href="#" style="padding:0px;">
                                                                <label for="disposition-radio-{{$value->id}}" class="disposition-label">
                                                                    ...
                                                                    <span class="pull-right">
                                                                        <input type='radio' class="radio_sms" id="disposition-radio-{{$value->id}}" @if($value->enable_sms == 1) onclick="ShowSmsPopUp()" @endif name='disposition' value='{{$value->id}}'/>
                                                                    </span>
                                                                </label>
                                                            </a>
                                            ...
                                            <li>
                                                <div class="row-fluid save-disposition-block">
                                                    ...
                                                    <button type="button" name="submit" id="redial" class="btn btn-success" value="save" disabled> Redial</button>
                                                </div>
                                            </li>
                                            <li>
