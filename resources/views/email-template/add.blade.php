...
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
         ...
         <section class="content-header">
                <h1>
                   <b>Add Email Templete</b>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="{{url('/dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">Configuration</li>
                    
                    <li class="active">Add Email Templete</li>
                </ol>
        </section>
        <section class="content-header">
                            ...
                            <div class="modal-body">
                                <div class="form-group m-b-10">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-daterange input-group col-md-12">
                                            <input type="text" class="form-control" name="subject" id="subject_box" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-daterange input-group col-md-12">
                                            <textarea type="text" class="form-control" name="template_html" value="" id="editor1" ></textarea>
                                        </div>
                                    </div>
